...
const ContactCard: React.FC<cardProps> = ({title}) => {
    ...
    return(
        ...
        <div className="flex flex-col">
            <div className="text-[3vh] py-[0.25rem]  text-shadow-xl text-white">{title}</div>
                <div className="w-[30vh] px-[0.25rem] backdrop-blur-md shadow-xl rounded-lg bg-radial-[at_0%_15%] from-white/50 to-zinc-900/30 to-100% justify-center items-center">
