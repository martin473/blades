...
const Blades = () => {
    ...
    const left = `M ${bladeW} 0 Q ${bladeW*(bladeSkew+1)} ${vBoxH/2} ${bladeW} ${vBoxH} Q 0 ${vBoxH} 0 ${vBoxH} Q ${bladeW*bladeSkew} ${vBoxH/2} 0 0 C ${bladeW} 0 0 0 ${bladeW} 0 `;
    const right = `M ${bladeW} 0 Q ${bladeW*(-bladeSkew+1)} ${vBoxH/2} ${bladeW} ${vBoxH} Q 0 ${vBoxH} 0 ${vBoxH} Q ${bladeW*(-bladeSkew)} ${vBoxH/2} 0 0 C ${bladeW} 0 0 0 ${bladeW} 0 `;
    
    return(
        <div className={`pointer-events-none ${motion} 
